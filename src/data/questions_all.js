export const names = [
  {
    answer: 'Ohio - Sherrod Brown (D), Rob Portman(R)',
  ...
  {
    answer: 'Ohio - Stave Chabot(R), Joyce Beatty(D), Marcy Kaptur(D)',
    category: 'American Government',
    id: 23,
...
export const questions = [
  ...
  },
  {
    ...
    answer: 'New York (Harbor)|Liberty Island|New Jersey|near New York City|on the Hudson (River)',
    category: 'Integrated Civics',
    subcategory: 'Geography'
  },
  {
